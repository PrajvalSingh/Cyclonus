...
const Contact = () => {
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_dxegvg2', 'template_12snmd8', e.target, 'user_fyMZ4z762Ajt4MJ61nHdT')
            .then((result) => {
                ...
                <section className="text-gray-600 body-font relative">
                    <div className="container px-5 py-24 mx-auto">
                        <div className="flex flex-col text-center w-full mb-12">
                            ...
                            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">In case of any doubts or suggestions feel free to send me a message!</p>
                        </div>
                            ...
                            <div className="flex flex-wrap -m-2">
                                <div className="p-2 w-1/2">
                                    <div className="relative">
                                        ...
                                        <input type="text" id="name" name="name" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" autoComplete='off' />
                                    </div>
                                </div>
                                <div className="p-2 w-1/2">
                                    <div className="relative">
